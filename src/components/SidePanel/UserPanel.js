...
class UserPanel extends React.Component {
    ...
    handleSignout = () => firebase.auth().signOut().then(() => console.log("signed out!"));
    ...
    changeAvatar = () => {
        this.state.userRef.updateProfile({photoURL: this.state.uploadedCroppedImage}).then(() => {
    ...
    render() {
        let {user, modal, previewImage, croppedImage} = this.state;
