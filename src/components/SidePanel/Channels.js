...
class Channels extends React.Component {
    ...
    addChannel = () => {
        let {channelsRef, channelName, channelDetails, user} = this.state;
    ...
    displayChannels = channels => (channels.length && channels.map(channel => (<Menu.Item
        key={channel.id}
